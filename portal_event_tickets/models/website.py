...
class Website(models.Model):
    ...
    ticket_transfer_success = fields.Html(
        ...
        default="<h1>Ticket is transfered successfully. We will instruct receiver on further actions.</h1>",  # noqa: E501
    )

    ticket_transfer_receiver_not_found = fields.Html(
        "Message ticket transfer: receiver not found",
        default="""<h1>User with the email is not found. The user has to <a href="/web/signup">signup</a> first.</h1>""",  # noqa: E501
    )
